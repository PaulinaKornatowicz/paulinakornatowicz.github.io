...
$(function() {
    ...
    $('.timeline li:nth-child(1),.timeline li:nth-child(3),.timeline li:nth-child(5),.timeline li:nth-child(7),.timeline li:nth-child(9)').removeClass("hidden").viewportChecker({
        classToAdd: 'visible animated fadeInLeft',offset: 100
    });

    $('.timeline li:nth-child(2),.timeline li:nth-child(4),.timeline li:nth-child(6),.timeline li:nth-child(8),.timeline li:nth-child(10)').removeClass("hidden").viewportChecker({
